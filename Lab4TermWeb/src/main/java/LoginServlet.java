...
// Вывести форму
        pw.println("<form action='' method='post'>Введите имя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
...
//////////////////////////////////////////////////////////////////////////////////////////
            String message = "Пользователь " + name + " прибыл в чат";
// Если сообщение не пустое, то
// По имени из сессии получить ссылку на объект ChatUser
                ChatUser author = new ChatUser("System", 0, "0");
